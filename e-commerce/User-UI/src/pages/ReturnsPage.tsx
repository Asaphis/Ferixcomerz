...
export default function ReturnsPage() {
  return (
    <AccountLayout>
      ...
      <div className="rounded-2xl p-3" style={{ backgroundColor: "var(--ferixcomerz-warning-bg)", border: "1px solid var(--ferixcomerz-warning-border)" }}>
        <p className="text-xs leading-relaxed" style={{ color: "var(--ferixcomerz-warning-text)" }}>

...
const faqs = [
  ...
  { category: "Account", q: "How can I contact customer support?", a: `You can reach us via email at ${import.meta.env.VITE_CONTACT_EMAIL || "info@ferixcomerz.com"}, by phone at ${import.meta.env.VITE_CONTACT_PHONE || "+260 97X XXX XXX"}, or through Live Chat in the app.` },
];

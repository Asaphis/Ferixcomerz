...
function CategoriesContent() {
  ...
  const columns: Column[] = [
    ...
    { key: 'showOnHome', label: 'On Home', render: (v) => <span style={{ padding: '2px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 600, background: v ? 'rgba(2,145,192,0.10)' : 'rgba(100,116,139,0.1)', color: v ? 'var(--primary)' : 'var(--text-muted)' }}>{v ? 'Yes' : 'No'}</span> },
